...
export const footerInfo = [
    {icon: faBuffer, info1: 'Consultify', id: 1},
    {icon: faMobileAlt, info1: '+12312312311', info2: 'ammarasif9@gmail.com', id: 2},
    {icon: faMapMarkedAlt, info1: 'Washington, USA', info2: 'Texas,USA', id: 3}
];